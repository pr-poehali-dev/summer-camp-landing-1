...
const ITEMS = [
  ...
  },
  {
    ...
    text: "Только качественные МК. Кулинарные, МК по сборке солнечных батарей и электронных проектов в клубе",
  ...
  },
  {
    ...
    text: "Даже после 18:00 дети вовлечены. Чат клуба работает до 21:00. Задания в чате",
