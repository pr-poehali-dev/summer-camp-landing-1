    ...
    >
      ...
      >
        ...
        <p className="text-base md:text-lg mb-6" style={{ color: "rgba(61,61,61,0.8)" }}>
          ...
          <br />
          Мы свяжемся с вами за несколько дней до начала смены.
        </p>
        ...
        >
          ...
          <ul className="space-y-2 text-sm" style={{ color: "#3D3D3D" }}>
            <li>✉️ Чек по оплате можно забрать в центре в первый день смены или любое удобное время</li>
            <li>🎒 За несколько дней до начала смены Вы будете добавлены в чат смены в Мах</li>
            <li>💰 Остаток за смену оплачивается в первый день смены</li>
          </ul>
        </div>
